        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TransactionType = table.Column<char>(type: "character(1)", nullable: false),
                    Description = table.Column<string>(type: "text", nullable: true),
                    TimeStamp = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    IsCustomerPickup = table.Column<bool>(type: "boolean", nullable: false),
                    FromLocation = table.Column<Guid>(type: "uuid", nullable: true),
                    ToLocation = table.Column<Guid>(type: "uuid", nullable: true),
                    FromStore = table.Column<Guid>(type: "uuid", nullable: true),
                    ToStore = table.Column<Guid>(type: "uuid", nullable: true),
                    FromWarehouse = table.Column<Guid>(type: "uuid", nullable: true),
                    ToWarehouse = table.Column<Guid>(type: "uuid", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    ComponentQuantity = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StoreInventories_Items_ItemId",
                        column: x => x.ItemId,
                        principalTable: "Items",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
